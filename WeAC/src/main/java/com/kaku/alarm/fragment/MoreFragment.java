...
import com.kaku.alarm.bean.Event.WallpaperEvent;
import com.kaku.alarm.util.DataCleanManager;
...
import com.kaku.alarm.view.CircleProgress;
                    ...
                    if ((appProcessInfo.importance > ActivityManager.RunningAppProcessInfo.
                        ...
                        if (pkgList.length > 0) {
                            for (String aPkgList : pkgList) {//pkgList 获得运行在该进程里的所有应用程序包名
                                ...
                                if (aPkgList.equals(" com.kaku.alarm")) {
